...
CS 305 Secure Software Portfolio – Artemis Financial
Project Overview
...
Artemis Financial is a financial services company seeking to improve the security of its web-based application. The goal of this project was to identify software vulnerabilities and refactor the application to protect sensitive financial data, ensure secure communication, and follow industry-standard security practices.
...
Challenges & Learning
  ...
  Interpreting dependency-check results and determining which vulnerabilities required mitigation versus suppression was the most challenging part. This improved my ability to assess real-world risk and make informed security decisions.
